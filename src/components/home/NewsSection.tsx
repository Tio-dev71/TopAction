    ...
    <section id="news" className="relative py-16 sm:py-24">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <FadeInStagger>
          <CarouselScroll>
            {posts.map((post) => (
              <FadeIn key={post.slug} className="min-w-[280px] sm:min-w-[320px] max-w-[350px] flex-shrink-0 snap-start h-full">
                <Link
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-4 sm:p-5">
                    <div className="mb-3 flex flex-col gap-2 text-xs font-medium text-muted-foreground sm:text-sm">
                    ...
                    <h3 className="text-base font-bold leading-snug tracking-tight text-card-foreground group-hover:text-primary transition-colors sm:text-lg line-clamp-2">
                      {post.title}
                    </h3>
